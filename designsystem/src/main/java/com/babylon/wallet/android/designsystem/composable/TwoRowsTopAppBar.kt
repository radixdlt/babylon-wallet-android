...
/**
 * Directly copied the internal [androidx.compose.material3.TwoRowsTopAppBar] but with some
 * changes to how elements are laid out.
 */
...
fun TwoRowsTopAppBar(
    ...
    require(maxHeight >= pinnedHeight) {
