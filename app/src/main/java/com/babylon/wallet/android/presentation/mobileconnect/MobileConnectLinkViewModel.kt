...
class MobileConnectLinkViewModel @Inject constructor(
    ...
    private lateinit var request: IncomingMessage.DappToWalletInteraction
    ...
    sealed class Event : OneOffEvent {
        ...
        data class HandleRequest(val request: IncomingMessage.DappToWalletInteraction) : Event()
    }
