        ...
        leadingIcon = {
            ...
            Image(
                ...
                colorFilter = if (itemIcon == null) {
                    ColorFilter.tint(RadixTheme.colors.primaryButton)
                } else {
                    null
                }
            )
...
@Composable
private fun GlossaryItem.resolveTitleFromGlossaryItem() = stringResource(
    when (this) {
        ...
        GlossaryItem.mnemonics -> error("Not supported here")
    }
)