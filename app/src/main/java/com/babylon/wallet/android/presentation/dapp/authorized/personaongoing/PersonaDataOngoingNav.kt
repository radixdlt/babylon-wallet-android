...
internal class PersonaDataOngoingPermissionArgs(val personaId: String, val requiredFields: RequiredFields) {
...
fun NavController.personaDataOngoing(personaAddress: String, request: RequiredFields) {
