...
import com.radixdlt.sargon.SecurityShieldBuilderRuleViolationReason
            ...
            SelectFactorsViewModel.State(
                ...
                status = SelectedPrimaryThresholdFactorsStatus.Invalid(
                    reason = SelectedPrimaryThresholdFactorsStatusInvalidReason.Other(
                        underlying = SecurityShieldBuilderRuleViolationReason.PrimaryRoleMustHaveAtLeastOneFactor()
                    )
                )
            )
        )
